...
public abstract class AbstractMongoDAO {
    ...
    public <T extends AbstractMongoEntity> T getEntityByTitle(String title, Class<T> clazz) {
        Query query = new Query(Criteria.where("title").is(title));
        return getMongoOperations().findOne(query, clazz, clazz.getSimpleName());
    }
    public <T extends AbstractMongoEntity> T getEntityByImageUrl(String imageurl, Class<T> clazz) {
        Query query = new Query(Criteria.where("image").is(imageurl));
        return getMongoOperations().findOne(query, clazz, clazz.getSimpleName());
    }
